...
app.post('/client/text/:id', (req, res) => {
    ...
    pythonProcess.stdout.on('data', (data) => {
        ...
        req.app.locals.prompts = mergedPrompts
        // var textChunk = data.toString('utf8');
        console.log('updating prompts:', app.locals.prompts)
                    ...
                    "nodes": [
                        {
                            ...
                            "leaves": [
                                {
                                    "text": "Rock climbing at Rumney in the morning"
                                }
                            ]
                        }
                    ]
